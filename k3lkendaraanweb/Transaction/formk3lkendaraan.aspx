<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="formk3lkendaraan.aspx.cs" Inherits="k3lkendaraanweb.Transaction.formk3lkendaraan" %>
    ...
    <form id="form1" runat="server">
        ...
        <asp:Table ID="Table1" runat="server" Height="98px" Width="225px">
               <asp:TableRow ID="TableRow3" runat="server">
                    ...
                    <asp:TableCell runat="server">
                              <br />
                     No Po:<asp:DropDownList ID="cmbpo" class="form-control" Width="200px" AutoPostBack="true" OnSelectedIndexChanged="cmbpo_SelectedIndexChanged" runat="server"></asp:DropDownList>
             ...
             <asp:TableRow ID="TableRow2" runat="server">
                      <asp:TableCell runat="server">
                              <br />
                     Supir:<asp:TextBox ID="txtsupir" Width="200px" runat="server"></asp:TextBox>
                  </asp:TableCell>
                    <asp:TableCell runat="server">
                         &nbsp;
                       </asp:TableCell>
                  <asp:TableCell runat="server">
                              <br />
                    No TTB:<asp:DropDownList ID="cmbTTB" Width="200px" class="form-control" AutoPostBack="true" OnSelectedIndexChanged="cmbTTB_SelectedIndexChanged" runat="server"></asp:DropDownList>
                  </asp:TableCell>
        </asp:TableRow>
             ...
             <asp:TableRow ID="TableRow5" runat="server">
                      <asp:TableCell runat="server">
                              <br />
                     Procurement PIC:<asp:TextBox ID="txtpic" Width="200px" runat="server" onkeyup="this.value = this.value.toUpperCase();"></asp:TextBox>
                  </asp:TableCell>
                         <asp:TableCell runat="server">
                             &nbsp;
                       </asp:TableCell>
