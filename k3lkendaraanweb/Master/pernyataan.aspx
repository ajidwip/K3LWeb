<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="pernyataan.aspx.cs" Inherits="k3lkendaraanweb.Master.pernyataan" %>
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <%:Styles.Render("~/Content/plugins/dataTables/dataTablesStyles") %>
    <%:Scripts.Render("~/plugins/dataTables")%>
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            <h2>Pertanyaan Form Penerimaan Barang</h2>
            <ol class="breadcrumb">
                <li>
                ...
                <li class="active">
                    <strong>Pertanyaan Form Penerimaan Barang</strong>
                </li>
            </ol>
        </div>
        <div class="col-lg-2">
    ...
    <script>
        ...
        window.url1 = "<%=ResolveUrl("~/Master/pernyataan.aspx/GetData") %>";
        window.urldtl1 = "<%=ResolveUrl("~/Master/pernyataan.aspx/GetDatadtl") %>";
        window.url2 = "<%=ResolveUrl("~/Master/pernyataan.aspx/crud1") %>";
        window.Key = 'No';
        window.url2dtl = "<%=ResolveUrl("~/Master/pernyataan.aspx/crudDtl") %>"
        window.filterdtl = 'No';
        window.filter1 = 'No';
